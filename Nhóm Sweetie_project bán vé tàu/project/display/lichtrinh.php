...
<section id="content-container" class="clearfix">
    <div class="center-wrap tt-relative clearfix">
            ...
            <h3 class="text-uppercase text-success">
                <span class="sprite ico-drive"></span>Ga Sài Gòn <i class="fa fa-exchange"> xuất phát</i>
            </h3>    
                ...
                <table class="table ">
                    ...
                    <tbody>
                         <tr class="route-row532">
                            ...
                            <td style="text-align: center;">2022-12-17</td>
                            <td style="text-align: center;">15:00 PM</td>
                            <td style="text-align: center;">
                                <p>
                                    <strong class="text-primary">
                                        995.000<sup>đ/vé</sup>
                                    </strong>
                                </p>
                            </td>
            ...
            <h3 class="text-uppercase text-success">
                <span class="sprite ico-drive"></span>Ga Hà Nội <i class="fa fa-exchange"> xuất phát</i>
            </h3>    
            <div class="table-responsive">
                <table class="table ">
                    <thead>
